<?php
/* * *********************************************
 * @类名:     SensitiveWordFilter
 * @参数:       
                 private $dict;    //过滤词  
                 private $dictPath;   //敏感词路径  
 * @方法         __construct()-赋值给成员变量
                 filter()-开始过滤敏感词
                
 * @功能:        为营造良好的网络环境，过滤一些不良敏感词汇
 * @注意：       初始化传入词库文件路径，词库文件每个词一个换行符。
                 如：
                 敏感1
                 敏感2
 ...
 * @作者:        http://blog.patpig.com/2016/01/10/php-sensitive-word-filter/?utm_source=tuicool&utm_medium=referral
   @整理:        不敢为天下           
*/
//图像处理类  
