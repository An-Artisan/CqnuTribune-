<?php
	...
	{		
		  ...
		  // 插入友情链接数据
		  $insert_navigation = "INSERT INTO manager.navigation (`navigation_sort`,`navigation_name`,`navigation_alias`,`navigation_url`) VALUES (1,'网站首页','cqnuTribune','http://localhost/CqnuTribune/index.php'),(2,'二手市场','secondHands','http://localhost/CqnuTribune/secondHands/index/secondHands.php'),(3,'失物招领','articlesFound','http://www.baidu.com'),(4,'学霸笔记','superScholarNote','http://localhost/CqnuTribune/mySchool/frontEnd/mySchool.php'),(5,'重师论坛','friendTribune','http://localhost/CqnuTribune/makeFriends/frontEnd/makeFriends.php'),(6,'个人中心','personalCenter','http://localhost/CqnuTribune/secondHands/publishSecondGoods/frontEnd/index.php'),(7,'消息中心','messageCenter','http://localhost/CqnuTribune/secondHands/publishSecondGoods/frontEnd/index.php?iframe=information.php')";
