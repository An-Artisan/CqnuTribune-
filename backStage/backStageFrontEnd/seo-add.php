...
<head>
    ...
    <script type="text/javascript" src="../js/seo_add.js"></script>
</head>
<?php 
...
<!-- 没有登录的进入该地址，提示用户登陆后台 -->
<body>
    <div id="seo-add" class="container-fluid wrapper nav-right">
        ...
        <div class="operate">
            <a href="config-add.html"><span class="glyphicon glyphicon-plus"></span>添加配置项</a>
            <a href="config.html"><span class="glyphicon glyphicon-refresh"></span>全部配置项</a>
        </div>
        <div class="content">
            <table id="tab1" class="table table-bordered">
                <tr>
                    ...
                    <td>
                        <input id="seo_name" type="text" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        <textarea class="form-control" id="seo_description" rows="3"></textarea>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" id="seo_author" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th></th>
                    <td>
                        <button type="button" id="add_seo_submit" class="btn btn-primary btn-sm">提交</button>
