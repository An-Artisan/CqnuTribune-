...
<head>
    ...
    <script src="../js/notice_modify.js"></script>
</head>
<?php 
...
<body>
    <div id="goods-modify" class="container-fluid wrapper nav-right">
        ...
        <div class="operate">
            <a href="notice-add.php"><span class="glyphicon glyphicon-plus"></span>添加分类</a>
            <a href="notice.php"><span class="glyphicon glyphicon-refresh"></span>全部分类</a>
        </div>
        <div class="content">
            <table class="tab1 table-bordered">
                <tr>
                    ...
                    <td>
                         <input type="text" id="modify_id" disabled="disabled" value="<?php echo $_GET['a_id']; ?>" class="form-control sm-input">
                    </td>
                </tr>
                <tr>
                    <th>分类标题：</th>
                    <td>
                        <input type="text" id="modify_name" onblur="modify_check(this);" value="<?php echo $_GET['content']; ?>" class="form-control md-input">
