...
<head>
    ...
    <script type="text/javascript" src="../js/notice_delete.js"></script>
</head>
<?php 
...
<body>
    <div id="goods" class="container-fluid wrapper nav-right">
        ...
        <div class="operate">
            <a href="notice-add.php"><span class="glyphicon glyphicon-plus"></span>添加公告</a>
            <a href="goods.php"><span class="glyphicon glyphicon-refresh"></span>全部公告</a>
        </div>
        <div class="content">
            <table id="tab1" class="table table-bordered table-hover">
                ...
                while($data = mysqli_fetch_object($result)) {
                 ?>
                    <tr>
                        <td><input class="form-control input1" type="text" name="" value="<?php echo $data->a_id; ?>"></td>
                        <td><?php echo $data->a_content; ?></td>
                        <td>
                            <a href="notice-modify.php?a_id=<?php echo $data->a_id;?>&content=<?php echo $data->a_content; ?>">修改</a>
                            <a style="cursor:pointer" onclick="delete_top_category(this);" name="<?php echo $data->a_id; ?>">删除</a>
                        </td>
                    </tr>
                <?php }?>
                </tbody>
