...
<!-- 没有登录的进入该地址，提示用户登陆后台 -->
<body>
    <div id="goods-add" class="container-fluid wrapper nav-right">
        ...
        <div class="operate">
            ...
            <a href="notice.php"><span class="glyphicon glyphicon-refresh"></span>全部公告</a>
        </div>
        <div class="content">
            <table class="tab1 table-bordered">
                <tr>
                    <th>公告内容：</th>
                    <td>
                        <input type="text" id="category_name"  class="form-control md-input">
                ...
                <tr>
                    <th></th>
                    <td>
                        <button type="button" id="category_submit" class="btn btn-primary btn-sm">提交</button>
