...
<head>
    ...
    <script type="text/javascript" src="../js/clean_email.js"></script>
</head>
<?php 
...
<body>
    <div id="email" class="container-fluid wrapper nav-right">
        ...
        <div class="operate">
            <a id="trash" href="#"><span class="glyphicon glyphicon-trash"></span>清空日志内容</a>
        </div>
        <div id="content" class="content">
            <p>
            <?php 
                $fp = fopen("../../cqnu.class/all.class/email.class/email.log", "r"); 
                if($fp){ 
                for($i=1;!feof($fp);$i++){ 
                echo fgets($fp). "<br />"; 
                    } 
