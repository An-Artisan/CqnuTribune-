...
<head>
    ...
    <script src="../js/navigation_modify.js"></script>
</head>
<?php 
...
<!-- 没有登录的进入该地址，提示用户登陆后台 -->
<body>
    <div id="navs-modify" class="container-fluid wrapper nav-right">
        ...
        <div class="content">
            ...
            <tr>
                <tr>
                    <th>ID:</th>
                    <td>
                        <input disabled="disabled" id="modify_navigation_id" value="<?php echo $_GET['navigation_id'] ?>" type="text" class="form-control xs-input">
                    </td>
                </tr>
                    <th>
                    ...
                    <td>
                         <input type="text" id="modify_navigation_name" value="<?php echo $_GET['navigation_name'] ?>" class="form-control xs-input">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                         <input type="text" id="modify_navigation_url" value="<?php echo $_GET['navigation_url'] ?>" class="form-control sm-input">
                    </td>
                </tr>
            ...
            <tr>
                    <th></th>
                    <td>
                        <button type="button" id="modify_navigation_submit" class="btn btn-primary btn-sm">提交</button>
