...
class Select{
	...
	public function page_result($table,$CurrentPage,$rowsPerPage){
				$result=mysqli_query($this->conn,"select * from $table order BY id desc" . " limit " . ($CurrentPage - 1) * $rowsPerPage . ", $rowsPerPage"); 
				// 根据传过来的参数查询
				return $result;
				// 返回结果
	}
	public function page_count($table){
